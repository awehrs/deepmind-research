...
<< DOC 
    ...
    git clone https://github.com/awehrs/deepmind-research.git

    # Install requirements
    pip install -r deepmind-research/perceiver/requirements.txt 
    ...
    bash deepmind-research/perceiver/train/launch_local.sh
